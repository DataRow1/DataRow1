...
- 💼 `Currently a data architect at one of the Big Four...`
- 🌱 `...designing and building a data platform in Azure.`
- 👀 `I'm interested in 🛠️ DIY, IkeaHacks, Lego, Harley-Davidson and Formula1.`
- :trollface: `Guilty of a stupid sense of humour.`
- 💭 `I identify as a kung fu master and must be referred to as sensei. (See? ☝️)`
